class Kolmogrov_Smirnov {
    ...
    tabla_teorica = [
        ...
        [0.18171, 0.20771, 0.23076, 0.25081, 0.27577, 0.29428, 0.31584, 0.33115],
        [0.17909, 0.21472, 0.22743, 0.25429, 0.27271, 0.29005, 0.31131, 0.32641],
        [0.17659, 0.10185, 0.22425, 0.25073, 0.26897, 0.28600, 0.30597, 0.32187],
        ...
        [0.16966, 0.19392, 0.24544, 0.24089, 0.25843, 0.27483, 0.29498, 0.30931],
    ...
    resultadoHipotesis(res_teorico,tabla){
        var res_observado = tabla[2][4]
        console.log("AAA "+res_observado)
    ...
    kolmogrov_smirnov(muestra, alpha){
        var tabla = []
        var sn = []
        var fx = []
        var fx2 = []
        ...
        var valor_chi_teorico = this.tabla_teorica[tabla.length-1][alpha]
        this.resultadoHipotesis(valor_chi_teorico,tabla)
    }
}
...
alpha = 0.05
obj.kolmogrov_smirnov(muestra,obj.tabla_alpha[String(alpha)])